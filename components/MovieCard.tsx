  ...
  return (
    <div className="group bg-zinc-900 col-span relative h-[12vw]">
      <img
        ...
        alt="Thumbnail"
        className="cursor-pointer object-cover transition duration shadow-cl rounded-md group-hover:opacity-90 sm:group-hover:opacity-0 delay-300 w-full h-[12vw]"
      />
      <div
